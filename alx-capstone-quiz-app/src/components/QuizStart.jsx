...
const QuizStart = () => {
  ...
  return (
    <div className="w-full max-w-xl bg-white rounded shadow p-6">
      ...
      <p className="text-gray-700 mb-4">Choose a topic, difficulty and number of questions.</p>
      {error ? (
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="pt-2 flex justify-end">
          <button
            type="submit"
            disabled={!canStart}
            className="bg-blue-600 disabled:opacity-60 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded"
          >
